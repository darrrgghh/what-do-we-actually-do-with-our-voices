...
Agreement with grouping harsh vocals into scream-like, growl-like, and hybrid/shout-like classes; optional comment on revising the system; matrix mapping each listed production technique to one or more classes (or not sure); open associations (emotions, imagery) for each class; self-reported frequency of thinking in those class terms while singing.

\paragraph{Historical and meta items (examples).}
Earliest recalled examples of growl, scream, and hybrid/shout vocals in metal or broader music history; whether animal comparisons help describe extreme vocals; open comments on classification and research; additional critiques or suggestions.
